...
We can also improve our number skipper. A quick look at the ascii table will show that all characters that a number can be composed of (`[0-9eE.+-]`) are in the character decimal interval `['+', '+' + 64]` which allows us to apply the fast set membership test trick that I covered [in this article](/art/asm_trk_0_set).

{{< collapsible-code path="content/art/jsn_1_hl/fst_skp.h" lang="c" title="Faster JSON entity skippers." >}}
...
{{< collapsible-code path="content/art/jsn_1_hl/u64_mem.h" lang="c" title="Reading 16 characters at a time." >}}
...
{{< collapsible-code path="content/art/jsn_1_hl/lut.h" lang="c" title="Removing a level of conditionals." >}}

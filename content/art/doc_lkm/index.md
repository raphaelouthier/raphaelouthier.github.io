...
```
cat build/Makefile
all:;make -C /lib/modules/6.15.10-402.asahi.fc41.aarch64+16k/build CFLAGS_prc/kmod.o="-DKMOD_NAM=\"TMP\" -DKMOD_ATH=\"BT\" -DKMOD_DSC=\"temp module\" -DKMOD_LCS=\"GPL\" -DKMOD_INI=\"prc_lkm_main\" " M=/home/bt/bt/work/art/lkm/build obj-m=mod.o mod-objs="prc/kmod.o prc/prc.o" modules
```

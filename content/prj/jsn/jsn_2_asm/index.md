...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/str_0.h" lang="asm" title="Using CMEQ to compare 8 chars at a time." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_cpl.h" lang="asm" title="GCC output." >}}
...
We'll use a variant of the char membership test described [here](/asm/trk_0_set). `"[]` are in a less-than-64-wide range in the ascii charset, so we can just initialize a mask in `x5` with their locations and use the `lsr` trick on the current char to quickly identify them.

If we see them, then we compare them manually. Otherwise we jump back.

{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_0_mbm.h" lang="asm" title="Using a set membership test to detect []\"." >}}
...
We'll use the method described in [a dedicated article](/asm/trk_1_set) and use this expression as a detector :
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_1_simd_mmb.h" lang="asm" title="A more complex but SIMD-compatible set membership test." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_2_simd_cmeq.h" lang="asm" title="Replacing our set membership test by a dump three-way comparison." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_3_gcc.h" lang="asm" title="The GCC way because apparently we're no match." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_4_nobp.h" lang="asm" title="Moving `UBFX` and `LDRSB` out of the speculation window." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_5_missbp.h" lang="asm" title="Making things a bit too non-conditional." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_6_nob.h" lang="asm" title="What the hell am I doing with my Sunday..." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_7_byp.h" lang="asm" title="Fast forward if 8 chars are spaces." >}}
...
{{< collapsible-code path="content/prj/jsn/jsn_2_asm/arr_8_22.h" lang="asm" title="Find the first non-space 4 bytes and process them. Then redo it." >}}
